...
function transformStreamWithRouter(router, appStream, opts) {
  ...
  function decodeChunk(chunk) {
    if (chunk instanceof Uint8Array) {
      return textDecoder2.decode(chunk, { stream: true });
    }
    return String(chunk);
  }
...
function parseQuery(input) {
  ...
  for (let i = 0; i < inputLength + 1; i++) {
    c2 = i === inputLength ? 38 : input.charCodeAt(i);
    switch (c2) {
      case 38: {
...
async function validateData(data, fn2) {
  if ("~standard" in fn2) {
    const result = await fn2["~standard"].validate(data);
...
function getValidatedQuery$1(event, validate) {
...
function setChunkedCookie(event, name, value, options) {
  ...
  setCookie$1(event, name, mainCookieValue, options);
...
async function getSession$1(event, config) {
  ...
  if (sealedSession) {
    const promise = unsealSession$1(event, config, sealedSession).catch(() => {
    }).then((unsealed) => {
...
async function updateSession$1(event, config, update) {
  const sessionName = config.name || DEFAULT_SESSION_NAME;
  const context = getEventContext(event);
  const session = context.sessions?.[sessionName] || await getSession$1(event, config);
  ...
  if (config.cookie !== false && event.res) {
    const sealed = await sealSession$1(event, config);
...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-DsCFT9aY.js");
...
const manifest = { "3ca53f453041cc086031d37e1b534f81559d29e55683f5c04d0dcdd5cfa0edf5": {
  functionName: "verifyEmailFn_createServerFn_handler",
  importer: () => import("./assets/verify-email-YJ5rWR2a.js")
}, "d4508c3d64d982d9f85070461b987b0c89f0127058a3ff7c4f6087b6875eff3a": {
  functionName: "getInitialAppDataServerFn_createServerFn_handler",
  importer: () => import("./assets/server-caller-DKj7nGWN.js")
}, "4596ef5b4feedd7a217fec1989ef269d0220462576d8c9b794f5882f5457cdad": {
  functionName: "getUserStatsServerFn_createServerFn_handler",
  importer: () => import("./assets/server-caller-DKj7nGWN.js")
}, "70d43dbaf985dbf4f6b04edf27586d5d094e09ab0fd755fe24f1d1c122c5738a": {
  functionName: "submitGuessServerFn_createServerFn_handler",
  importer: () => import("./assets/server-caller-DKj7nGWN.js")
}, "1c0f9ace5600a2f1189a668721c52618fa900f8c2f13e80d3f5d74f76c64f0e9": {
  functionName: "syncAnonymousSessionServerFn_createServerFn_handler",
  importer: () => import("./assets/server-caller-DKj7nGWN.js")
}, "5881fddf03040cfe3287810f620c995dfe8ab8da53b48634f0eaf1cb7810ee29": {
  functionName: "getThemeServerFn_createServerFn_handler",
  importer: () => import("./assets/theme-4RYmTdsl.js")
}, "71df1c81de1627f92aad64454efb0cbee53b33c45818d2ce8fd4e7ad46e6b1c9": {
  functionName: "setThemeServerFn_createServerFn_handler",
  importer: () => import("./assets/theme-4RYmTdsl.js")
}, "5d2e99dc465a0403fe1a005d75b073716eb2f5dc9e6d0e05f83f09c27e2fc19b": {
  functionName: "resendVerificationEmailFn_createServerFn_handler",
  importer: () => import("./assets/verify-email-D26eYDD9.js")
} };
...
function createStartHandler(cb) {
  ...
  const getEntries = async () => {
    if (routerEntry === null) {
      routerEntry = await import("./assets/router-CDQTwt2f.js").then((n) => n.r);
    }
    if (startEntry === null) {
...
export {
  removeResponseHeader as A,
  requestHandler as B,
  sealSession as C,
  setCookie as D,
  setResponseHeader as E,
  setResponseHeaders as F,
  setResponseStatus as G,
  HEADERS as H,
  ...
  getRequestHost as q,
  getRequestIP as r,
  getRequestProtocol as s,
  getRequestUrl as t,
  getResponse as u,
  getResponseHeader as v,
  getResponseHeaders as w,
  getResponseStatus as x,
  getSession as y,
  getValidatedQuery as z
};
